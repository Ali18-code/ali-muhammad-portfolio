      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {certifications.map((cert, idx) => (
            <div
              key={idx}
              className="p-6 rounded-xl border border-slate-800/90 bg-slate-900/40 hover:border-indigo-500/40 transition-all flex flex-col justify-between group"
            >
              <div>
                ...
                {cert.image && (
                  <div className="mb-4 rounded-lg overflow-hidden border border-slate-700/50 hover:border-indigo-500/50 transition-colors bg-slate-950">
              ...
              <div className="pt-3 border-t border-slate-800/70 flex items-center justify-between gap-2">
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="flex items-center gap-1.5 text-xs font-mono px-3 py-1.5 rounded border border-indigo-500/40 bg-indigo-500/10 hover:bg-indigo-500/20 text-indigo-300 transition-all"
                >
                  <span>Verify</span>
