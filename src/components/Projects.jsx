 ...
 * Renders a single interactive project case study card.
 *
...
const ProjectCard = ({ project }) => (
  <Tilt
    ...
    className="group"
  >
    <div className="p-6 rounded-xl border border-slate-800/90 bg-slate-900/40 hover:border-indigo-500/50 hover:shadow-[0_0_25px_rgba(99,102,241,0.15)] hover:bg-slate-900/80 transition-all h-full flex flex-col">
 ...
 * Displays the user's featured software engineering and AI projects.
